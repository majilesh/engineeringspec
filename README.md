...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.11 adopt . --quickstart --maintainer @your-org/platform --dry-run
npx --yes @engineeringspec/cli@0.1.0-rc.11 propose --id ES-my-change --title "My change" --from-diff --base origin/main --dry-run
npx --yes @engineeringspec/cli@0.1.0-rc.11 review --spec-dir docs/engineering-specs --base origin/main --strict --format markdown
npx --yes @engineeringspec/cli@0.1.0-rc.11 prepare ES-my-change --spec-dir docs/engineering-specs --base origin/main --strict --format markdown
npx --yes @engineeringspec/cli@0.1.0-rc.11 init --template feature --id ES-my-change
npx --yes @engineeringspec/cli@0.1.0-rc.11 validate ENGINEERING_SPEC.md
npx --yes @engineeringspec/cli@0.1.0-rc.11 validate docs/engineering-specs
npx --yes @engineeringspec/cli@0.1.0-rc.11 normalize ENGINEERING_SPEC.md --digest
npx --yes @engineeringspec/cli@0.1.0-rc.11 inspect ENGINEERING_SPEC.md --path src/example.ts
npx --yes @engineeringspec/cli@0.1.0-rc.11 coverage ENGINEERING_SPEC.md --fail-on uncovered
npx --yes @engineeringspec/cli@0.1.0-rc.11 gate ENGINEERING_SPEC.md --base origin/main --receipt gate-receipt.json
npx --yes @engineeringspec/cli@0.1.0-rc.11 check ENGINEERING_SPEC.md --base origin/main --strict
npx --yes @engineeringspec/cli@0.1.0-rc.11 context ENGINEERING_SPEC.md --path src/example.ts --base origin/main --format markdown
npx --yes @engineeringspec/cli@0.1.0-rc.11 explain ENGINEERING_SPEC.md --path src/example.ts --base origin/main
npx --yes @engineeringspec/cli@0.1.0-rc.11 catalogue docs/engineering-specs --query session --format json
```
...
npx --yes @engineeringspec/cli@0.1.0-rc.11 gate docs/engineering-specs/ES-my-change.engineering-spec.md \
  --base origin/main --require-status approved --receipt gate-receipt.json

# Local / CI smoke without git history
npx --yes @engineeringspec/cli@0.1.0-rc.11 gate docs/engineering-specs/ES-my-change.engineering-spec.md --changed src/api.ts
```
...
steps:
  - uses: actions/checkout@v4
    with:
      fetch-depth: 0
  - uses: majilesh/engineeringspec@a23486e3bf4e4b175c06390406c2fd401a0f2515
    with:
...
After tagging, `majilesh/engineeringspec@v0.1.0-rc.11` is acceptable for less sensitive repos; SHA pins remain preferred. See [production-gate.md](docs/production-gate.md) for required checks and CODEOWNERS.
