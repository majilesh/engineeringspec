# EngineeringSpec public brand assets

This directory contains the repository-ready subset of the reviewed mark-first brand kit.

**Canonical descriptor:** Change authority for AI coding agents.<br>
**Supporting line:** Reviewed authority before code. Final-diff verification after.

## Use now

| Surface | Asset |
|---|---|
| Website navigation | `logo/lockup-horizontal.svg` |
| Dark navigation | `logo/lockup-horizontal-inverse.svg` |
| GitHub repository avatar | `social/avatar-800.png` |
| GitHub social preview | `social/github-social-1280x640.png` |
| Link preview | `social/og-1200x630.png` |
| Browser icon | `logo/favicon.svg` and `exports/png/favicon-{32,48}.png` |
| Maskable application icon | `exports/png/maskable-512.png` |
