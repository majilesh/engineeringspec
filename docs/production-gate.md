...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.11 select docs/engineering-specs \
...
- Action + git tag: `v0.1.0-rc.11` (when published) tracks package version `0.1.0-rc.11`.
- npm dist-tag: `next` identifies the current release candidate; enforcing commands above pin exact version `0.1.0-rc.11`.
