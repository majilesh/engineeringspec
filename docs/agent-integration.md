...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.10 adopt . --spec docs/engineering-specs/ES-change.engineering-spec.md
```
...
escalating the contract. Before ending your turn, self-check with:
  ...
  npx --yes @engineeringspec/cli@0.1.0-rc.10 check --spec-dir docs/engineering-specs \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.10 select docs/engineering-specs --base origin/main --worktree --allow-contract-only --strict
