...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.9 adopt . --quickstart \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.9 doctor . \
...
npx --yes @engineeringspec/cli@0.1.0-rc.9 status \
...
npx --yes @engineeringspec/cli@0.1.0-rc.9 review \
...
npx --yes @engineeringspec/cli@0.1.0-rc.9 catalogue docs/engineering-specs \
  --path src/example.ts

# Preview a closure without editing; add --write only after review
npx --yes @engineeringspec/cli@0.1.0-rc.9 transition \
