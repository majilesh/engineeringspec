...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.10 adopt . --quickstart \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.10 doctor . \
...
npx --yes @engineeringspec/cli@0.1.0-rc.10 status \
...
npx --yes @engineeringspec/cli@0.1.0-rc.10 context <approved-spec> \
