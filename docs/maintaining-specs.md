...
Current enforcement (RC18) pins the separately reviewed RFC 0014 runtime anchor `9dc9ef0fd1861f35781610921cacb416849e3e5f`: the trusted `main` commit that merged the bundled Action runtime (`action/cli.mjs`). The RC16 anchor `ddf813e4e69d9b2f9a9eb3f0f241747746021cf3` and the RC14 identity above remain historical release facts.
