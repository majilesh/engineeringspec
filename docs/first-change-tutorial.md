...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.7 doctor . --spec-dir docs/engineering-specs --base origin/main
npx --yes @engineeringspec/cli@0.1.0-rc.7 status --spec-dir docs/engineering-specs --base origin/main --allow-contract-only
```
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.7 init docs/engineering-specs/ES-dark-mode.engineering-spec.md \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.7 context docs/engineering-specs/ES-dark-mode.engineering-spec.md \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.7 check --spec-dir docs/engineering-specs --base origin/main --allow-contract-only --strict
```
