...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.12 doctor . --spec-dir docs/engineering-specs --base origin/main
npx --yes @engineeringspec/cli@0.1.0-rc.12 status --spec-dir docs/engineering-specs --base origin/main --allow-contract-only
```
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.12 init docs/engineering-specs/ES-dark-mode.engineering-spec.md \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.12 prepare ES-dark-mode \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.12 context docs/engineering-specs/ES-dark-mode.engineering-spec.md \
