...
```sh
engineeringspec init docs/engineering-specs/ES-dark-mode.engineering-spec.md \
...
```sh
engineeringspec context docs/engineering-specs/ES-dark-mode.engineering-spec.md \
