...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.11 doctor . --spec-dir docs/engineering-specs --base origin/main
npx --yes @engineeringspec/cli@0.1.0-rc.11 status --spec-dir docs/engineering-specs --base origin/main --allow-contract-only
```
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.11 init docs/engineering-specs/ES-dark-mode.engineering-spec.md \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.11 prepare ES-dark-mode \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.11 context docs/engineering-specs/ES-dark-mode.engineering-spec.md \
...
```sh
npx --yes @engineeringspec/cli@0.1.0-rc.11 check --spec-dir docs/engineering-specs --base origin/main --allow-contract-only --strict
```
